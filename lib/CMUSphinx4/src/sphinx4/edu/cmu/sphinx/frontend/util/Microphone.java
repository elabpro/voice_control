 ...
 * into Data objects. When the method <code>startRecording()</code> is called, a new service will be created and used to
...
public class Microphone extends BaseDataProcessor {
     ...
     * danger of dropping out the frames if decoding service will
    ...
    */
    ...
    class RecordingThread extends Thread {
        ...
        /**
         * Creates the service with the given name
         *
        ...
        /**
         * Starts the service, and waits for recorder to be ready
         */
        @Override
        public void start() {
            started = false;
        ...
        /**
         * Stops the service. This method does not return until recording has actually stopped, and all the data has been
        ...
        public void stopRecording() {
            ...
            // flush can not be called here because the audio-line might has been set to  null already by the mic-service
//    	    audioLine.flush();
        }
